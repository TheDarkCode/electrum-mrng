...
from electrum_mrng import Wallet, WalletStorage
from electrum_mrng.util import UserCancelled, InvalidPassword
from electrum_mrng.base_wizard import BaseWizard
...
MSG_ENTER_ANYTHING = _("Please enter a seed phrase, a master key, a list of "
                       "MorningStar addresses, or a list of private keys")
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Electrum-MRNG  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum-mrng.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self):
        ...
        self.set_layout(vbox, title=_('Electrum-MRNG wallet'))
