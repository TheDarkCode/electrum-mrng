...
from electrum_mrng.bitcoin import TYPE_ADDRESS
from electrum_mrng import WalletStorage, Wallet
from electrum_mrng_gui.kivy.i18n import _
from electrum_mrng.paymentrequest import InvoiceStore
from electrum_mrng.util import profiler, InvalidPassword
from electrum_mrng.plugins import run_hook
from electrum_mrng.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_mrng_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_mrng_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_mrng_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_mrng_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_mrng_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_mrng_gui.kivy.uix.screens')
...
from electrum_mrng.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_mrng.network import DEFAULT_PORTS
    ...
    def on_new_intent(self, intent):
        if intent.getScheme() != 'morningstar':
            return
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'MRNG')
    ...
    def on_qr(self, data):
        from electrum_mrng.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_mrng.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_mrng.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_mrng_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_mrng_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_mrng_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_mrng_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-mrng.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-MRNG', message,
                            app_icon=icon, app_name='Electrum-MRNG')
        except ImportError:
