import select, time, electrum_mrng as electrum, Queue
from electrum_mrng import Connection, Interface, SimpleConfig
from electrum_mrng.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    server = 'electrum-mrng.bysh.me:50002:s'
