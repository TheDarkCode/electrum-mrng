...
from electrum_mrng.bitcoin import (bc_address_to_hash_160, xpub_from_pubkey,
...
from electrum_mrng.transaction import deserialize, Transaction
from electrum_mrng.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if TESTNET else "MorningStar"
