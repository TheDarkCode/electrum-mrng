...
from electrum_mrng_gui.qt.util import *
from .plugin import TIM_NEW, TIM_RECOVER, TIM_MNEMONIC
from ..hw_wallet.qt import QtHandlerBase, QtPluginBase

from electrum_mrng.i18n import _
from electrum_mrng.plugins import hook, DeviceMgr
from electrum_mrng.util import PrintError, UserCancelled
from electrum_mrng.wallet import Wallet, Standard_Wallet
...
RECOMMEND_PIN = _(
    ...
    "for your morningstars if your device is lost or stolen.")
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "morningstars in the wallet behind it.  A passphrase is not a PIN. "
    ...
    def request_trezor_init_settings(self, wizard, method, device):
        ...
        if method in [TIM_NEW, TIM_RECOVER]:
            ...
            if method == TIM_MNEMONIC:
                ...
                def set_enabled():
                    from electrum_mrng.keystore import is_xprv
...
class SettingsDialog(WindowModalDialog):
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has morningstars in it!")
                if not self.question(msg, title=title,
        ...
        pin_msg = QLabel(_("PIN protection is strongly recommended.  "
                           ...
                           "stealing your morningstars if they obtain physical "
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "%s device can spend your morningstars.") % plugin.device)
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the morningstars "
