...
from electrum_mrng.util import format_satoshis, set_verbosity
from electrum_mrng.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_mrng.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-mrng create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid MorningStar address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-mrng setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-mrng setconfig' to change your settings")
        return True
