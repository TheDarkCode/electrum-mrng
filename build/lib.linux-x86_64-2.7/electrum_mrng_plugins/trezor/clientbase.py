...
from electrum_mrng.keystore import bip39_normalize_passphrase
from electrum_mrng.bitcoin import serialize_xpub
    ...
    def callback_PassphraseRequest(self, req):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the morningstars in the wallet.") % self.device
        else:
...
class TrezorClientBase(GuiMixin, PrintError):
    ...
    #    return self.get_address('MorningStar', self.expand_path(derivation))
